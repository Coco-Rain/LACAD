...
from model.origin_x_transformer import AbsolutePositionalEmbedding, Encoder
...
class DiffusionTransformer(nn.Module):
    def __init__(
        ...
        self.output_proj = nn.Linear(tx_dim * 2 if dense_output_connection else tx_dim,
                                     latent_dim * 2 if dual_output else latent_dim)
