...
import CONSTANTS
from diffusion.origin_text_denoising_diffusion import GaussianDiffusion, Trainer
from model.origin_diffusion_transformer import DiffusionTransformer
...
def main(args):
    ...
    # args.enc_dec_model = 'D:\\Develop\\Diffusion-Model\\latent-diffusion-for-language-main\\bart-base'
    ...
    model = DiffusionTransformer(
        ...
        seq2seq=(args.dataset_name in {'xsum', 'qqp', 'qg', 'wmt14-de-en', 'wmt14-en-de', 'cq_code', 'code'}),
...
if __name__ == "__main__":
    ...
    if args.eval or args.resume_training or args.eval_test:
        ...
        heldout_params = {'wandb_name', 'output_dir', 'resume_dir', 'eval', 'eval_test', 'num_samples',
                          'sampling_timesteps', 'sampling_schedule', 'seq2seq_candidates', 'scale', 'sampler',
                          'resume_training'}
